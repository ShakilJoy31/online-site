        ...
        <div className='mx-2 mt-4 pb-36 lg:mx-12 md:mx-8 lg:mt-0 md:mt-0'>
            ...
            <div className='grid w-full lg:justify-between md:justify-between gap-x-6 lg:flex md:flex'>
                ...
                <div style={{
                    ...
                    <img style={{ borderRadius: '50%' }} className='w-20 h-20 mr-4' src={localStorageUser ? localStorageUser?.userPhoto : 'https://i.ibb.co/d6CBxZx/download-1.png'} alt="" />
                        <div>
                ...
                <div className='grid w-full lg:justify-between md:justify-between gap-x-6 lg:flex md:flex'>
                    ...
                    <div style={{
                        ...
                        <div className=''>
                            ...
                            <p className='my-4'>Refer your friends and Earn referral reward up to 3 levels</p>
                            <div>
